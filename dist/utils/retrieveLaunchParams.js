...
import { retrieveFromLocation, retrieveFromPerformance, retrieveFromStorage, saveToStorage, } from "../launch-params/index.js";
...
export function retrieveLaunchParams() {
    ...
    for (const retrieve of [
        ...
        try {
            ...
            saveToStorage(lp); // Save the retrieved parameters to session storage for future use
            return lp;
        }
        catch (e) {
            errors.push(e);
